...
: ${AMENT_CURRENT_PREFIX:="/home/user/FinalProject/ros2_ws/install/real_my_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/real_my_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/real_my_moveit_config/environment/path.sh"
